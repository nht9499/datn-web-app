<template>
  <div class="column items-center">
    <div class="audio__player">
      <div class="audio__player-play cursor-pointer" @click="togglePlayer">
        <img
          :src="option_.coverImage ? option_.coverImage : CoverImageDefault"
          :class="`${isPlaying && option_.coverRotate ? 'audio__player-spin-anim' : ''}`" />
        <div class="audio__player-play-icon">
          <img :src="isPlaying ? IconPause : IconPlay" />
        </div>
      </div>
    </div>
    <div class="audio__player-progress-container flex-1">
...
import { formatSecond } from '@/transform/string'
import IconPlay from '@/assets/img/play.png'
import IconPause from '@/assets/img/pause.png'
import CoverImageDefault from '@/assets/img/cover.png'
...
.audio__player-progress-point {
  ...
  margin-top: -8px;
  background-color: $primary !important;
  box-shadow: $primary 0px 0px 10px 0px !important;
}
